    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_primer', models.DateField(default=datetime.date.today, verbose_name='Примера в мире')),
                ('budget', models.PositiveSmallIntegerField(default=0, help_text='Указать сумму в долларах', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveSmallIntegerField(default=0, help_text='Указать сумму в долларах', verbose_name='Сборы в США')),
                ('fees_in_world', models.PositiveSmallIntegerField(default=0, help_text='Указать сумму в долларах', verbose_name='Сборы в мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
